...
const IntroScreenC = ({ navigation }) => {
  const handleNext = async () => {
    await storeData('introFlag', true);
    navigation.navigate('BT');
  };
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.description}>
          Get expert medical advice from the comfort of your home. With our
          seamless video consultation feature, you can connect with your doctor
          virtually, ensuring your healthcare is just a click away.
        </Text>
        ...
        <View style={styles.navigationButtonsContainer}>
          ...
          <Pressable
            ...
            onPress={handleNext} // Navigate to the home screen
          >
            <Ionicons
              name="arrow-forward"
              size={24}
