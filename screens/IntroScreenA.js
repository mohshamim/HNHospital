    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.description}>
          Access all your medical reports and records in one place. Stay
          informed about your health with quick and secure access to lab
          results, prescriptions, and radiology reports—anytime, anywhere.
        </Text>
